...
| --- | --- | --- |
| Frontend | `e.iplavras.com.br` | Vite/React estático |
| Backend | `e-api.iplavras.com.br` | NestJS persistente |
...
CORS_ORIGIN=https://e.iplavras.com.br
PUBLIC_VOTER_URL=https://e.iplavras.com.br
ADMIN_EMAILS=eduardopedrosamf@gmail.com
...
Depois conecte `e-api.iplavras.com.br`. A Hostinger cuida do certificado
...
```dotenv
VITE_API_URL=https://e-api.iplavras.com.br/api
...
não podem conter segredos. Conecte `e.iplavras.com.br` depois do primeiro
build.
...
1. `https://e-api.iplavras.com.br/api/health` retorna `{"status":"ok"}`.
2. `https://e.iplavras.com.br` abre a tela de senha.
